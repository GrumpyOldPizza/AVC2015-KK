...
int main()
{
 ...
 FILE *fp;
 fp = fopen("magcal.txt", "r");
 // fp = fopen("acccal.txt", "r");
...
#include "external/mymathlib/choleski.c"
#include "external/mymathlib/copy_vector.c"
#include "external/mymathlib/get_submatrix.c"
#include "external/mymathlib/hessenberg_elementary.c"
#include "external/mymathlib/identity_matrix.c"
#include "external/mymathlib/interchange_cols.c"
#include "external/mymathlib/interchange_rows.c"
#include "external/mymathlib/lower_triangular.c"
#include "external/mymathlib/matrix_x_its_transpose.c"
#include "external/mymathlib/multiply_matrices.c"
#include "external/mymathlib/qr_hessenberg_matrix.c"
#include "external/mymathlib/transpose_square_matrix.c"
#include "external/mymathlib/upper_triangular.c"
